...
<P>“More haste, less speed”, after project step 16(Yes! I was hesitating and lost a lot of time), I finally decided to move foward to something SIMPLE but still core knowlege base on what I learned from the course, which means I am going to use SportsStore project as my template, and I keep telling myself that I am playing with this templates until I am fully understand each part and swith that into something with my new idea becasue I don't want to lose my passion and the same time, I know I need more practices. </P>
